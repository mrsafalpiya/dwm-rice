...
static Key keys[] = {
  ...
  { MODKEY,                       XK_w,      spawn,          SHCMD("$BROWSER") },
	...
	{ Mod1Mask|ControlMask,         XK_k,      switchtag,      { .ui = SWITCHTAG_UP    | SWITCHTAG_VIEW } },
	{ Mod1Mask|ControlMask,         XK_j,      switchtag,      { .ui = SWITCHTAG_DOWN  | SWITCHTAG_VIEW } },
	{ Mod1Mask|ControlMask,         XK_l,      switchtag,      { .ui = SWITCHTAG_RIGHT | SWITCHTAG_VIEW } },
	{ Mod1Mask|ControlMask,         XK_h,      switchtag,      { .ui = SWITCHTAG_LEFT  | SWITCHTAG_VIEW } },
	{ Mod1Mask|ControlMask|ShiftMask,XK_k,     switchtag,      { .ui = SWITCHTAG_UP    | SWITCHTAG_TAG | SWITCHTAG_VIEW } },
	{ Mod1Mask|ControlMask|ShiftMask,XK_j,     switchtag,      { .ui = SWITCHTAG_DOWN  | SWITCHTAG_TAG | SWITCHTAG_VIEW } },
	{ Mod1Mask|ControlMask|ShiftMask,XK_l,     switchtag,      { .ui = SWITCHTAG_RIGHT | SWITCHTAG_TAG | SWITCHTAG_VIEW } },
	{ Mod1Mask|ControlMask|ShiftMask,XK_h,     switchtag,      { .ui = SWITCHTAG_LEFT  | SWITCHTAG_TAG | SWITCHTAG_VIEW } },
	{ MODKEY,                       XK_0,      switchtag,      { .ui = SWITCHTAG_DOWN  | SWITCHTAG_VIEW } },
